package common
{
   public class Consts extends Object
   {
      ...
      public static const SPEED_TEISOKU:int = 1;
      
      public static const SPEED_KOUSOKU:int = 2;
      
      public static const SPEED_DIVIDE:int = 10;
      
      private static const SLOTITEM_RARITY_NAMES:Array = ["コモン","レア","ホロ","Sホロ","SSホロ","SSホロ"];
      ...
      public static const planeOffset:Object = {
         "19":{
            "r":30,
            "x":0,
            "y":13
      ...
      public static const ENEMY_PLANETYPES:Array = [[517,520,524],[518,521,525,526,544,546],[547],[548],[549]];
      ...
      public static const MISSION_TYPE_SUPPORT:Array = [33,34,117,118,125,126,133,134,141,142];
      
      public static const MISSION_TYPE_SUPPORT_EVENT:Array = [125,126];
      
      public static const USE_COMBINE_FLEET:Boolean = true;
   }
}
