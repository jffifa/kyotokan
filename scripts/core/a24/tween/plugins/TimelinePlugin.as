package a24.tween.plugins
{
   ...
   public final class TimelinePlugin extends PulginTween24
   {
      ...
      {
         var _loc6_:TimelinePlugin = null;
         var param3:int = (param3) || (param1.currentFrame);
         var param4:int = (param4) || (param1.totalFrames);
         var param5:Function = param5 || Ease24._Linear;
         _loc6_ = new TimelinePlugin();
