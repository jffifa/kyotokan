package vo
{
   ...
   public class MasterSlotItemData extends Object
   {
      ...
      public function setEquipTypeData(param1:Array) : void
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            _equipTypeCount = _equipTypeCount + 1;
            _loc3_++;
         }
      }
      ...
      {
         var _loc2_:Object = _getItemData(param1);
         return Util.getArray(_loc2_,"api_broken",[0,0,0,0])[0];
      }
      
      public function getAmmoFromBroken(param1:int) : int
      {
         var _loc2_:Object = _getItemData(param1);
         return Util.getArray(_loc2_,"api_broken",[0,0,0,0])[1];
      }
      
      public function getSteelFromBroken(param1:int) : int
      {
         var _loc2_:Object = _getItemData(param1);
         return Util.getArray(_loc2_,"api_broken",[0,0,0,0])[2];
      }
      
      public function getBauxFromBroken(param1:int) : int
      {
         var _loc2_:Object = _getItemData(param1);
         return Util.getArray(_loc2_,"api_broken",[0,0,0,0])[3];
      }
      ...
      {
         var _loc2_:Object = _getItemData(param1);
         return Util.getArray(_loc2_,"api_type",[0,0,0,0])[2];
      }
