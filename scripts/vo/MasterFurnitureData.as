package vo
{
   ...
   public class MasterFurnitureData extends Object
   {
      ...
      public function setData(param1:Array) : void
      {
         ...
         while(_loc8_ < param1.length)
         {
            ...
            {
               _loc5_ = [1,1,1,4,4,1,4,1,4,5,1,3,1,1,4,1,1,3,1,1,1,1,3,3,3,1,4,3,3,4,4,4,4,4,4,4];
      ...
      public function getWindowType(param1:int) : int
      {
         ...
         {
            return _windowDic[_loc2_]["window_type"];
         }
         return 1;
      }
