                           ...
                           if(param2.hasOwnProperty("api_mst_furniture") && param2["api_mst_furniture"] is Array)
                           {
                              ...
                              if(param2.hasOwnProperty("api_mst_payitem") && param2["api_mst_payitem"] is Array)
                              {
                                 ...
                                 if(param2.hasOwnProperty("api_mst_item_shop"))
                                 {
                                    ...
                                    {
                                       _loc6_ = param2["api_mst_maparea"];
                                       _loc4_ = param2["api_mst_mapinfo"];
                                       _loc3_ = param2.hasOwnProperty("api_mst_mapcell")?param2["api_mst_mapcell"]:[];
                                       _loc5_ = param2.hasOwnProperty("api_mst_mapbgm")?param2["api_mst_mapbgm"]:[];
                                       DataFacade.getMapData().setMasterData(_loc6_,_loc4_,_loc3_,_loc5_);
                                       if(param2.hasOwnProperty("api_mst_mission"))
                                       {
                                          ...
                                          if(param2.hasOwnProperty("api_mst_const"))
                                          {
                                             ...
                                             AppFacade.showErrorScreen("No BGMMster Data.");
                                             return;
                                          }
