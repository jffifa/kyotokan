package common.models
{
   ...
   public class PayItemData extends Object
   {
      ...
      public function setMasterData(param1:Array) : void
      {
         ...
         _getItemDataFromMaster(5)["list_index"] = 7;
         _getItemDataFromMaster(6)["list_index"] = 8;
         _getItemDataFromMaster(7)["list_index"] = 9;
         _getItemDataFromMaster(8)["list_index"] = 10;
         _getItemDataFromMaster(9)["list_index"] = 11;
         _getItemDataFromMaster(10)["list_index"] = 12;
         _getItemDataFromMaster(13)["list_index"] = 13;
         _getItemDataFromMaster(15)["list_index"] = 14;
         _getItemDataFromMaster(17)["list_index"] = 15;
         _getItemDataFromMaster(16)["list_index"] = 16;
         _getItemDataFromMaster(18)["list_index"] = 17;
         _getItemDataFromMaster(19)["list_index"] = 18;
         _getItemDataFromMaster(20)["list_index"] = 19;
         _getItemDataFromMaster(21)["list_index"] = 20;
         _getItemDataFromMaster(23)["list_index"] = 21;
         _getItemDataFromMaster(22)["list_index"] = 22;
      ...
      public function getListIndex() : Array
      {
         ...
         var itemIDs:Array = new Array(24);
         ...
         while(i < indexes.length)
         {
            ...
            if(itemID > 0 && listIndex > 0 && listIndex <= 24)
            {
