package vo
{
   ...
   public class MasterShipData extends Object
   {
      ...
      public function getBroken(param1:int) : Array
      {
         var _loc2_:Object = _getShipObj(param1);
         return Util.getArray(_loc2_,"api_broken",[0,0,0,0]).concat();
      }
